...
class UserProfile(ManagedEntity):
    ...
    gender = models.SmallIntegerField(choices=GENDER_CHOICES, default=None, null=True)
    diet = models.SmallIntegerField(choices=DIET_CHOICES, default=None, null=True)
