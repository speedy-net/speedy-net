                ...
                try:
                    ...
                    if (photo_is_valid):
                        ...
                        for label in image.aws_raw_image_moderation_results["ModerationLabels"]:
                            if (label["Name"] in ["Explicit Nudity", "Sexual Activity", "Explicit Sexual Activity", "Graphic Male Nudity", "Exposed Male Genitalia", "Graphic Female Nudity", "Exposed Female Genitalia", "Barechested Male", "Partial Nudity", "Male Swimwear Or Underwear", "Weapon Violence", "Weapons", "Corpses"]):
