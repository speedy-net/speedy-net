                ...
                try:
                    ...
                    if (photo_is_valid):
                        ...
                        for label in image.aws_raw_image_moderation_results["ModerationLabels"]:
                            if (label["Name"] in ["Explicit Nudity", "Sexual Activity", "Graphic Male Nudity", "Graphic Female Nudity", "Barechested Male", "Partial Nudity", "Male Swimwear Or Underwear", "Weapon Violence", "Weapons"]):
