...
class DeactivateSiteProfileView(LoginRequiredMixin, generic.FormView):
    ...
    def form_valid(self, form):
        ...
        if settings.SITE_ID == 1:
            message = _('Your Speedy Net and Speedy Match accounts has been deactivated. You can reactivate it any time.')
        else:
            message = _('Your {} account has been deactivated. You can reactivate it any time. Your Speedy Net account remains intact.'.format(_(current_site.name)))
