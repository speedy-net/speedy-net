...
class LikeTestCase(TestCase):
    ...
    def test_anonymous_cannot_like(self):
        self.assertFalse(expr=self.anon.has_perm('likes.like', self.other_user))

    def test_user_cannot_like_self(self):
        self.assertFalse(expr=self.user.has_perm('likes.like', self.user))
...
class UnlikeTestCase(TestCase):
    ...
    def test_anonymous_cannot_unlike(self):
        self.assertFalse(expr=self.anon.has_perm('likes.unlike', self.other_user))

    def test_user_cannot_unlike_self(self):
        self.assertFalse(expr=self.user.has_perm('likes.unlike', self.user))
...
class ViewLikesTestCase(TestCase):
    ...
    def test_anonymous_cannot_view_likes(self):
        self.assertFalse(expr=self.anon.has_perm('likes.view_likes', self.user))

    def test_other_user_cannot_view_likes(self):
        self.assertFalse(expr=self.other_user.has_perm('likes.view_likes', self.user))

    def test_user_can_view_likes(self):
        self.assertTrue(expr=self.user.has_perm('likes.view_likes', self.user))
