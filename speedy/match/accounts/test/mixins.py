class SpeedyMatchAccountsLanguageMixin(object):
    def set_up(self):
        ...
        _please_select_relationship_status_match_error_message_dict = {'en': 'Please select relationship status match.', 'he': '_____ # ~~~~ TODO'}
        ...
        _at_least_one_relationship_status_match_option_should_be_5_hearts_error_message_dict = {'en': 'At least one relationship status match option should be five hearts.', 'he': '_____ # ~~~~ TODO'}
