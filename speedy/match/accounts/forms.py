...
class SpeedyMatchProfileBaseForm(forms.ModelForm):
    # fields_with_choices = ('diet', 'smoking_status', 'marital_status', 'diet_match', 'smoking_status_match', 'marital_status_match') # ~~~~ TODO: remove this line!
    validators = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        if ('diet' in self.fields):
            ...
            # self.fields['diet'].choices = self.instance.user.get_diet_choices() # ~~~~ TODO: remove this line!
        ...
        if ('smoking_status' in self.fields):
            ...
            # self.fields['smoking_status'].choices = self.instance.get_smoking_status_choices() # ~~~~ TODO: remove this line!
        if ('marital_status' in self.fields):
            ...
            # self.fields['marital_status'].choices = self.instance.get_marital_status_choices() # ~~~~ TODO: remove this line!
        ...
        if ('diet_match' in self.fields):
            ...
            # self.fields['diet_match'].choices = self.instance.get_diet_match_choices() # ~~~~ TODO: remove this line!
        if ('smoking_status_match' in self.fields):
            ...
            # self.fields['smoking_status_match'].choices = self.instance.get_smoking_status_match_choices() # ~~~~ TODO: remove this line!
        if ('marital_status_match' in self.fields):
            ...
            # self.fields['marital_status_match'].choices = self.instance.get_marital_status_match_choices() # ~~~~ TODO: remove this line!
        # for field_name, field in self.fields.items(): # ~~~~ TODO: remove this line!
        #     if (field_name in self.fields_with_choices): # ~~~~ TODO: remove this line!
        #         field.widget.choices = field.choices # ~~~~ TODO: remove this line!
