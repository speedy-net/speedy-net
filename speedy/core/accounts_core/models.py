...
from speedy.core.accounts_core.validators import get_username_validators, get_slug_validators
...
from speedy.core.utils import normalize_username, normalize_slug, generate_confirmation_token
...
class UserEmailAddress(TimeStampedModel):
    ...
    def send_confirmation_email(self):
        msg_count = self.mail('accounts_core/email/verify_email')
