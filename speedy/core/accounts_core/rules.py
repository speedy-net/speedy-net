...
add_perm('accounts_core.view_profile', has_access_perm & ~is_blocked & ~has_blocked)
add_perm('accounts_core.view_profile_username', is_self)
add_perm('accounts_core.view_profile_info', has_access_perm)
add_perm('accounts_core.view_profile_dob_day_month', has_access_perm_for_dob_day_month)
add_perm('accounts_core.view_profile_dob_year', has_access_perm_for_dob_year)
add_perm('accounts_core.edit_profile', is_self)
add_perm('accounts_core.confirm_useremailaddress', is_email_address_owner & ~email_address_is_confirmed)
add_perm('accounts_core.delete_useremailaddress', is_email_address_owner & ~email_address_is_primary)
add_perm('accounts_core.setprimary_useremailaddress', is_email_address_owner & email_address_is_confirmed)
add_perm('accounts_core.change_useremailaddress', is_email_address_owner)
add_perm('accounts_core.view_useremailaddress', email_address_is_confirmed & has_access_perm_for_email_address)
