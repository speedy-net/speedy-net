        ...
        def set_up(self):
            ...
            _you_already_are_friends_with_this_user_error_message_dict_by_both_genders = {
                ...
                'es': {
                    ...
                    get_both_genders_context_from_genders(user_gender=User.GENDER_MALE_STRING, other_user_gender=User.GENDER_MALE_STRING): "Ya eres amiga de este usuario.",
                    get_both_genders_context_from_genders(user_gender=User.GENDER_MALE_STRING, other_user_gender=User.GENDER_OTHER_STRING): "Ya eres amiga de este usuario.",
                    ...
                    get_both_genders_context_from_genders(user_gender=User.GENDER_OTHER_STRING, other_user_gender=User.GENDER_MALE_STRING): "Ya eres amiga de este usuario.",
                    get_both_genders_context_from_genders(user_gender=User.GENDER_OTHER_STRING, other_user_gender=User.GENDER_OTHER_STRING): "Ya eres amiga de este usuario.",
                },
                'pt': {
                    ...
                    get_both_genders_context_from_genders(user_gender=User.GENDER_MALE_STRING, other_user_gender=User.GENDER_FEMALE_STRING): "Tu já és amiga desta utilizadora.",
                    get_both_genders_context_from_genders(user_gender=User.GENDER_MALE_STRING, other_user_gender=User.GENDER_MALE_STRING): "Tu já és amiga deste utilizador.",
                    get_both_genders_context_from_genders(user_gender=User.GENDER_MALE_STRING, other_user_gender=User.GENDER_OTHER_STRING): "Tu já és amiga deste utilizador.",
                    get_both_genders_context_from_genders(user_gender=User.GENDER_OTHER_STRING, other_user_gender=User.GENDER_FEMALE_STRING): "Tu já és amiga desta utilizadora.",
                    get_both_genders_context_from_genders(user_gender=User.GENDER_OTHER_STRING, other_user_gender=User.GENDER_MALE_STRING): "Tu já és amiga deste utilizador.",
                    get_both_genders_context_from_genders(user_gender=User.GENDER_OTHER_STRING, other_user_gender=User.GENDER_OTHER_STRING): "Tu já és amiga deste utilizador.",
                },
                'he': {
            ...
            _this_user_already_has_friends_error_message_to_format_dict_by_both_genders = {
                ...
                'es': {
                    **{get_both_genders_context_from_genders(user_gender=user_gender, other_user_gender=User.GENDER_FEMALE_STRING): "Esta usuaria ya tiene {0} amigas. No se puede tener más de {1} amigas en Speedy Net. Pídele que elimine amigos antes de continuar." for user_gender in User.ALL_GENDERS},
                    **{get_both_genders_context_from_genders(user_gender=user_gender, other_user_gender=User.GENDER_MALE_STRING): "Esta usuaria ya tiene {0} amigos. No se puede tener más de {1} amigos en Speedy Net. Pídele que elimine amigos antes de continuar." for user_gender in User.ALL_GENDERS},
                    **{get_both_genders_context_from_genders(user_gender=user_gender, other_user_gender=User.GENDER_OTHER_STRING): "Esta usuaria ya tiene {0} amigos. No se puede tener más de {1} amigos en Speedy Net. Pídele que elimine amigos antes de continuar." for user_gender in User.ALL_GENDERS},
                },
                'pt': {
                    **{get_both_genders_context_from_genders(user_gender=user_gender, other_user_gender=User.GENDER_FEMALE_STRING): "Este utilizador já tem {0} amigos. Ele não pode ter mais que {1} amigos no Speedy Net. Peça para que remova amigos antes de continuar." for user_gender in User.ALL_GENDERS},
                    **{get_both_genders_context_from_genders(user_gender=user_gender, other_user_gender=User.GENDER_MALE_STRING): "Este utilizador já tem {0} amigos. Ele não pode ter mais que {1} amigos no Speedy Net. Peça para que remova amigos antes de continuar." for user_gender in User.ALL_GENDERS},
                    **{get_both_genders_context_from_genders(user_gender=user_gender, other_user_gender=User.GENDER_OTHER_STRING): "Este utilizador já tem {0} amigos. Ele não pode ter mais que {1} amigos no Speedy Net. Peça para que remova amigos antes de continuar." for user_gender in User.ALL_GENDERS},
                },
                'he': {
