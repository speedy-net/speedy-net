...
if (django_settings.TESTS):
    class SpeedyCoreAdminLanguageMixin(object):
        def set_up(self):
            ...
            _speedy_net_profiles_dict = {'en': "Speedy Net Profiles", 'fr': "Profils Speedy Net", 'de': "Speedy Net-Profile", 'es': "Perfiles de Speedy Net", 'pt': "Perfis do Speedy Net", 'it': "Profili Speedy Net", 'nl': "Speedy Net Profielen", 'sv': "Speedy Net-profiler", 'ko': "Speedy Net 프로필", 'fi': "Speedy Net profiili", 'he': "פרופילים ספידי נט"}
            _speedy_match_profiles_dict = {'en': "Speedy Match Profiles", 'fr': "Profils Speedy Match", 'de': "Speedy Match-Profile", 'es': "Perfiles de Speedy Match", 'pt': "Perfis do Speedy Match", 'it': "Profili Speedy Match", 'nl': "Speedy Match Profielen", 'sv': "Speedy Match-profiler", 'ko': "Speedy Match 프로필", 'fi': "Speedy Match Profiilit", 'he': "פרופילים ספידי מץ'"}
