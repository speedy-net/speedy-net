...
if (django_settings.TESTS):
    ...
    class SpeedyCoreFeedbackLanguageMixin(SpeedyCoreBaseLanguageMixin):
        ...
        def set_up(self):
            ...
            _please_contact_us_by_email_error_message_dict = {'en': 'Please contact us by email.', 'fr': 'Veuillez nous contacter par e-mail.', 'de': "Bitte kontaktieren Sie uns per E-Mail.", 'es': "Por favor, contáctanos por correo electrónico.", 'pt': "Entre em contacto conosco por e-mail.", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': 'אנא צרו איתנו קשר באמצעות הדואר האלקטרוני.'}
            _not_17_error_message_dict = {'en': 'Not 17.', 'fr': 'Pas 17.', 'de': "Nicht 17.", 'es': "No 17.", 'pt': "Não 17.", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': 'לא 17.'}
