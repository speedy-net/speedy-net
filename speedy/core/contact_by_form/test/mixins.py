...
if (django_settings.TESTS):
    ...
    class SpeedyCoreFeedbackLanguageMixin(SpeedyCoreBaseLanguageMixin):
        ...
        def set_up(self):
            ...
            _please_contact_us_by_email_error_message_dict = {'en': 'Please contact us by email.', 'fr': 'Please contact us by email.', 'de': "_____ # ~~~~ TODO", 'es': "_____ # ~~~~ TODO", 'pt': "_____ # ~~~~ TODO", 'he': 'אנא צרו איתנו קשר באמצעות הדואר האלקטרוני.'}
            _not_17_error_message_dict = {'en': 'Not 17.', 'fr': 'Pas 17.', 'de': "_____ # ~~~~ TODO", 'es': "_____ # ~~~~ TODO", 'pt': "_____ # ~~~~ TODO", 'he': 'לא 17.'}
