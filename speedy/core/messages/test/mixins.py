...
if (django_settings.TESTS):
    ...
    class SpeedyCoreMessagesLanguageMixin(SpeedyCoreBaseLanguageMixin):
        ...
        def set_up(self):
            ...
            _you_have_a_new_message_on_speedy_net_subject_dict = {'en': "You have a new message on Speedy Net", 'fr': "Vous avez un nouveau message sur Speedy Net", 'he': "יש לך הודעה חדשה בספידי נט"}
            _you_have_a_new_message_on_speedy_match_subject_dict = {'en': "You have a new message on Speedy Match", 'fr': "Vous avez un nouveau message sur Speedy Match", 'he': "יש לך הודעה חדשה בספידי מץ'"}
