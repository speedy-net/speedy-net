...
if (django_settings.TESTS):
    ...
    class SpeedyCoreMessagesLanguageMixin(SpeedyCoreBaseLanguageMixin):
        ...
        def set_up(self):
            ...
            _you_have_a_new_message_on_speedy_net_subject_dict = {'en': "You have a new message on Speedy Net", 'fr': "Vous avez un nouveau message sur Speedy Net", 'de': "Sie haben eine neue Mitteilung erhalten auf Speedy Net", 'es': "Tienes un nuevo mensaje en Speedy Net", 'pt': "Tu tens uma nova mensagem em Speedy Net", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': "יש לך הודעה חדשה בספידי נט"}
            _you_have_a_new_message_on_speedy_match_subject_dict = {'en': "You have a new message on Speedy Match", 'fr': "Vous avez un nouveau message sur Speedy Match", 'de': "Sie haben eine neue Mitteilung erhalten auf Speedy Match", 'es': "Tienes un nuevo mensaje en Speedy Match", 'pt': "Tu tens uma nova mensagem em Speedy Match", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': "יש לך הודעה חדשה בספידי מץ'"}
