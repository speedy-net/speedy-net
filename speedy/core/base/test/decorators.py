...
if (django_settings.TESTS):
    ...
    conditional_test = lambda conditional_function: unittest.skipUnless(condition=conditional_function(), reason="This test is irrelevant in {}.".format(tests_settings.SITE_NAME_EN_DICT[django_settings.SITE_ID]))
