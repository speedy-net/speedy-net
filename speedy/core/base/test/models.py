...
if (django_settings.TESTS):
    ...
    class SiteTestCase(django_test.TestCase):
        ...
        def validate_all_values(self):
            ...
            self.assertEqual(first=len(self.all_other_language_codes), second={django_settings.SPEEDY_NET_SITE_ID: 45, django_settings.SPEEDY_MATCH_SITE_ID: 45, django_settings.SPEEDY_COMPOSER_SITE_ID: 1, django_settings.SPEEDY_MAIL_SOFTWARE_SITE_ID: 1}[self.site.id])
            ...
            if (self.language_code == 'en'):
                self.assertListEqual(list1=self.all_other_full_http_hosts, list2={django_settings.SPEEDY_NET_SITE_ID: ['https://fr.{domain}/'.format(domain=self.site.domain), 'https://de.{domain}/'.format(domain=self.site.domain), 'https://es.{domain}/'.format(domain=self.site.domain), 'https://pt.{domain}/'.format(domain=self.site.domain), 'https://it.{domain}/'.format(domain=self.site.domain), 'https://nl.{domain}/'.format(domain=self.site.domain), 'https://ja.{domain}/'.format(domain=self.site.domain), 'https://ru.{domain}/'.format(domain=self.site.domain), 'https://zh.{domain}/'.format(domain=self.site.domain), 'https://pl.{domain}/'.format(domain=self.site.domain), 'https://fa.{domain}/'.format(domain=self.site.domain), 'https://he.{domain}/'.format(domain=self.site.domain), 'https://ko.{domain}/'.format(domain=self.site.domain), 'https://ar.{domain}/'.format(domain=self.site.domain), 'https://id.{domain}/'.format(domain=self.site.domain), 'https://uk.{domain}/'.format(domain=self.site.domain), 'https://tr.{domain}/'.format(domain=self.site.domain), 'https://vi.{domain}/'.format(domain=self.site.domain), 'https://cs.{domain}/'.format(domain=self.site.domain), 'https://sv.{domain}/'.format(domain=self.site.domain), 'https://fi.{domain}/'.format(domain=self.site.domain), 'https://hu.{domain}/'.format(domain=self.site.domain), 'https://th.{domain}/'.format(domain=self.site.domain), 'https://el.{domain}/'.format(domain=self.site.domain), 'https://ms.{domain}/'.format(domain=self.site.domain), 'https://sr.{domain}/'.format(domain=self.site.domain), 'https://ro.{domain}/'.format(domain=self.site.domain), 'https://bn.{domain}/'.format(domain=self.site.domain), 'https://ca.{domain}/'.format(domain=self.site.domain), 'https://no.{domain}/'.format(domain=self.site.domain), 'https://bg.{domain}/'.format(domain=self.site.domain), 'https://da.{domain}/'.format(domain=self.site.domain), 'https://sk.{domain}/'.format(domain=self.site.domain), 'https://hi.{domain}/'.format(domain=self.site.domain), 'https://et.{domain}/'.format(domain=self.site.domain), 'https://hr.{domain}/'.format(domain=self.site.domain), 'https://az.{domain}/'.format(domain=self.site.domain)], django_settings.SPEEDY_MATCH_SITE_ID: ['https://fr.{domain}/'.format(domain=self.site.domain), 'https://de.{domain}/'.format(domain=self.site.domain), 'https://es.{domain}/'.format(domain=self.site.domain), 'https://pt.{domain}/'.format(domain=self.site.domain), 'https://it.{domain}/'.format(domain=self.site.domain), 'https://nl.{domain}/'.format(domain=self.site.domain), 'https://ja.{domain}/'.format(domain=self.site.domain), 'https://ru.{domain}/'.format(domain=self.site.domain), 'https://zh.{domain}/'.format(domain=self.site.domain), 'https://pl.{domain}/'.format(domain=self.site.domain), 'https://fa.{domain}/'.format(domain=self.site.domain), 'https://he.{domain}/'.format(domain=self.site.domain), 'https://ko.{domain}/'.format(domain=self.site.domain), 'https://ar.{domain}/'.format(domain=self.site.domain), 'https://id.{domain}/'.format(domain=self.site.domain), 'https://uk.{domain}/'.format(domain=self.site.domain), 'https://tr.{domain}/'.format(domain=self.site.domain), 'https://vi.{domain}/'.format(domain=self.site.domain), 'https://cs.{domain}/'.format(domain=self.site.domain), 'https://sv.{domain}/'.format(domain=self.site.domain), 'https://fi.{domain}/'.format(domain=self.site.domain), 'https://hu.{domain}/'.format(domain=self.site.domain), 'https://th.{domain}/'.format(domain=self.site.domain), 'https://el.{domain}/'.format(domain=self.site.domain), 'https://ms.{domain}/'.format(domain=self.site.domain), 'https://sr.{domain}/'.format(domain=self.site.domain), 'https://ro.{domain}/'.format(domain=self.site.domain), 'https://bn.{domain}/'.format(domain=self.site.domain), 'https://ca.{domain}/'.format(domain=self.site.domain), 'https://no.{domain}/'.format(domain=self.site.domain), 'https://bg.{domain}/'.format(domain=self.site.domain), 'https://da.{domain}/'.format(domain=self.site.domain), 'https://sk.{domain}/'.format(domain=self.site.domain), 'https://hi.{domain}/'.format(domain=self.site.domain), 'https://et.{domain}/'.format(domain=self.site.domain), 'https://hr.{domain}/'.format(domain=self.site.domain), 'https://az.{domain}/'.format(domain=self.site.domain)], django_settings.SPEEDY_COMPOSER_SITE_ID: ['https://he.{domain}/'.format(domain=self.site.domain)], django_settings.SPEEDY_MAIL_SOFTWARE_SITE_ID: ['https://he.{domain}/'.format(domain=self.site.domain)]}[self.site.id])
