...
if (django_settings.TESTS):
    ...
    class SiteTestCase(django_test.TestCase):
        ...
        def validate_all_values(self):
            ...
            self.assertListEqual(list1=self.all_language_codes, list2={django_settings.SPEEDY_NET_SITE_ID: all_46_language_codes, django_settings.SPEEDY_MATCH_SITE_ID: all_46_language_codes, django_settings.SPEEDY_COMPOSER_SITE_ID: ['en', 'he'], django_settings.SPEEDY_MAIL_SOFTWARE_SITE_ID: ['en', 'he']}[self.site.id])
            if (self.language_code == 'en'):
                all_45_other_language_codes = ['fr', 'de', 'es', 'pt', 'it', 'nl', 'ja', 'ru', 'zh', 'pl', 'fa', 'he', 'ko', 'ar', 'id', 'uk', 'tr', 'vi', 'cs', 'sv', 'fi', 'hu', 'th', 'el', 'ms', 'sr', 'ro', 'bn', 'ca', 'no', 'bg', 'da', 'sk', 'hi', 'et', 'hr', 'az', 'zh-yue', 'lt', 'sl', 'eu', 'hy', 'uz', 'ta', 'lv']
                self.assertListEqual(list1=self.all_other_language_codes, list2={django_settings.SPEEDY_NET_SITE_ID: all_45_other_language_codes, django_settings.SPEEDY_MATCH_SITE_ID: all_45_other_language_codes, django_settings.SPEEDY_COMPOSER_SITE_ID: ['he'], django_settings.SPEEDY_MAIL_SOFTWARE_SITE_ID: ['he']}[self.site.id])
            elif (self.language_code == 'fr'):
                all_45_other_language_codes = ['en', 'de', 'es', 'pt', 'it', 'nl', 'ja', 'ru', 'zh', 'pl', 'fa', 'he', 'ko', 'ar', 'id', 'uk', 'tr', 'vi', 'cs', 'sv', 'fi', 'hu', 'th', 'el', 'ms', 'sr', 'ro', 'bn', 'ca', 'no', 'bg', 'da', 'sk', 'hi', 'et', 'hr', 'az', 'zh-yue', 'lt', 'sl', 'eu', 'hy', 'uz', 'ta', 'lv']
                self.assertListEqual(list1=self.all_other_language_codes, list2={django_settings.SPEEDY_NET_SITE_ID: all_45_other_language_codes, django_settings.SPEEDY_MATCH_SITE_ID: all_45_other_language_codes}[self.site.id])
            elif (self.language_code == 'de'):
                all_45_other_language_codes = ['en', 'fr', 'es', 'pt', 'it', 'nl', 'ja', 'ru', 'zh', 'pl', 'fa', 'he', 'ko', 'ar', 'id', 'uk', 'tr', 'vi', 'cs', 'sv', 'fi', 'hu', 'th', 'el', 'ms', 'sr', 'ro', 'bn', 'ca', 'no', 'bg', 'da', 'sk', 'hi', 'et', 'hr', 'az', 'zh-yue', 'lt', 'sl', 'eu', 'hy', 'uz', 'ta', 'lv']
                self.assertListEqual(list1=self.all_other_language_codes, list2={django_settings.SPEEDY_NET_SITE_ID: all_45_other_language_codes, django_settings.SPEEDY_MATCH_SITE_ID: all_45_other_language_codes}[self.site.id])
            ...
            if (self.language_code == 'en'):
                all_45_other_full_http_hosts = ['https://fr.{domain}/'.format(domain=self.site.domain), 'https://de.{domain}/'.format(domain=self.site.domain), 'https://es.{domain}/'.format(domain=self.site.domain), 'https://pt.{domain}/'.format(domain=self.site.domain), 'https://it.{domain}/'.format(domain=self.site.domain), 'https://nl.{domain}/'.format(domain=self.site.domain), 'https://ja.{domain}/'.format(domain=self.site.domain), 'https://ru.{domain}/'.format(domain=self.site.domain), 'https://zh.{domain}/'.format(domain=self.site.domain), 'https://pl.{domain}/'.format(domain=self.site.domain), 'https://fa.{domain}/'.format(domain=self.site.domain), 'https://he.{domain}/'.format(domain=self.site.domain), 'https://ko.{domain}/'.format(domain=self.site.domain), 'https://ar.{domain}/'.format(domain=self.site.domain), 'https://id.{domain}/'.format(domain=self.site.domain), 'https://uk.{domain}/'.format(domain=self.site.domain), 'https://tr.{domain}/'.format(domain=self.site.domain), 'https://vi.{domain}/'.format(domain=self.site.domain), 'https://cs.{domain}/'.format(domain=self.site.domain), 'https://sv.{domain}/'.format(domain=self.site.domain), 'https://fi.{domain}/'.format(domain=self.site.domain), 'https://hu.{domain}/'.format(domain=self.site.domain), 'https://th.{domain}/'.format(domain=self.site.domain), 'https://el.{domain}/'.format(domain=self.site.domain), 'https://ms.{domain}/'.format(domain=self.site.domain), 'https://sr.{domain}/'.format(domain=self.site.domain), 'https://ro.{domain}/'.format(domain=self.site.domain), 'https://bn.{domain}/'.format(domain=self.site.domain), 'https://ca.{domain}/'.format(domain=self.site.domain), 'https://no.{domain}/'.format(domain=self.site.domain), 'https://bg.{domain}/'.format(domain=self.site.domain), 'https://da.{domain}/'.format(domain=self.site.domain), 'https://sk.{domain}/'.format(domain=self.site.domain), 'https://hi.{domain}/'.format(domain=self.site.domain), 'https://et.{domain}/'.format(domain=self.site.domain), 'https://hr.{domain}/'.format(domain=self.site.domain), 'https://az.{domain}/'.format(domain=self.site.domain), 'https://zh-yue.{domain}/'.format(domain=self.site.domain), 'https://lt.{domain}/'.format(domain=self.site.domain), 'https://sl.{domain}/'.format(domain=self.site.domain), 'https://eu.{domain}/'.format(domain=self.site.domain), 'https://hy.{domain}/'.format(domain=self.site.domain), 'https://uz.{domain}/'.format(domain=self.site.domain), 'https://ta.{domain}/'.format(domain=self.site.domain), 'https://lv.{domain}/'.format(domain=self.site.domain)]
                self.assertListEqual(list1=self.all_other_full_http_hosts, list2={django_settings.SPEEDY_NET_SITE_ID: all_45_other_full_http_hosts, django_settings.SPEEDY_MATCH_SITE_ID: all_45_other_full_http_hosts, django_settings.SPEEDY_COMPOSER_SITE_ID: ['https://he.{domain}/'.format(domain=self.site.domain)], django_settings.SPEEDY_MAIL_SOFTWARE_SITE_ID: ['https://he.{domain}/'.format(domain=self.site.domain)]}[self.site.id])
