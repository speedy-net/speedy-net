...
if (django_settings.TESTS):
    ...
    class SettingsOnlyEnglishTestCase(SiteTestCase):
        ...
        def test_languages(self):
            ...
            self.assertEqual(first=len([language_code for language_code, language_name in django_settings.LANGUAGES]), second={django_settings.SPEEDY_NET_SITE_ID: 38, django_settings.SPEEDY_MATCH_SITE_ID: 38, django_settings.SPEEDY_COMPOSER_SITE_ID: 2, django_settings.SPEEDY_MAIL_SOFTWARE_SITE_ID: 2}[self.site.id])
            self.assertEqual(first=len(django_settings.LANGUAGES), second={django_settings.SPEEDY_NET_SITE_ID: 38, django_settings.SPEEDY_MATCH_SITE_ID: 38, django_settings.SPEEDY_COMPOSER_SITE_ID: 2, django_settings.SPEEDY_MAIL_SOFTWARE_SITE_ID: 2}[self.site.id])
