...
def activation_step_html(speedy_match_profile):
    return attribute_html(profile=speedy_match_profile, attribute_name="activation_step")


@register.filter
def number_of_matches_html(speedy_match_profile):
    return attribute_html(profile=speedy_match_profile, attribute_name="number_of_matches")


@register.filter
def number_of_friends_html(speedy_net_profile):
    return attribute_html(profile=speedy_net_profile, attribute_name="number_of_friends")
