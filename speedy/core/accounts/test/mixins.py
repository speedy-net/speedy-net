...
if (django_settings.TESTS):
    ...
    class SpeedyCoreAccountsLanguageMixin(SpeedyCoreBaseLanguageMixin):
        ...
        def set_up(self):
            ...
            _username_is_required_error_message_dict = {'en': 'Username is required.', 'fr': 'Nom d’utilisateur requis.', 'de': "Benutzername ist erforderlich.", 'es': "Se requiere nombre de usuario.", 'pt': "O nome de utilizador é obrigatório.", 'it': "Il nome utente è richiesto.", 'nl': "Gebruikersnaam is vereist.", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': 'שם המשתמש/ת נדרש.'}
