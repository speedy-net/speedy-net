...
if (django_settings.TESTS):
    ...
    class SpeedyCoreAccountsLanguageMixin(SpeedyCoreBaseLanguageMixin):
        ...
        def set_up(self):
            ...
            _invalid_password_error_message_dict = {'en': 'Invalid password.', 'fr': 'Mot de passe invalide.', 'de': "Ungültiges Passwort.", 'es': "Contraseña no válida.", 'pt': "Palavra-passe inválida.", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': 'הסיסמה לא תקינה.'}
            ...
            _youve_already_confirmed_this_email_address_error_message_dict = {'en': "You've already confirmed this email address.", 'fr': "Vous avez déjà confirmé cette adresse e-mail.", 'de': "Sie haben diese E-Mail-Adresse bereits bestätigt.", 'es': "Ya has confirmado esta dirección de correo electrónico.", 'pt': "Tu já confirmaste esta caixa de e-mail.", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': 'כבר אימתת את כתובת הדואר האלקטרוני שלך.'}
            _invalid_confirmation_link_error_message_dict = {'en': "Invalid confirmation link.", 'fr': "Lien de confirmation invalide.", 'de': "Ungültiger Bestätigungslink.", 'es': "Enlace de confirmación no válido.", 'pt': "Link de confirmação inválido.", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': 'קישור אימות לא חוקי.'}
            _youve_confirmed_your_email_address_message_dict = {'en': "You've confirmed your email address.", 'fr': "Vous avez confirmé votre adresse e-mail.", 'de': "Sie haben Ihre E-Mail-Adresse bestätigt.", 'es': "Has confirmado tu dirección de correo electrónico.", 'pt': "Tu confirmaste teu e-mail.", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': 'אימתת את כתובת הדואר האלקטרוני שלך.'}
            _the_email_address_was_deleted_error_message_dict = {'en': 'The email address was deleted.', 'fr': 'L’adresse e-mail a été supprimée.', 'de': "Die E-Mail-Adresse wurde gelöscht.", 'es': "La dirección de correo electrónico fue eliminada.", 'pt': "A direcção de e-mail foi excluída.", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': 'כתובת הדואר האלקטרוני נמחקה.'}
            _you_have_changed_your_primary_email_address_error_message_dict = {'en': 'You have made this email address primary.', 'fr': 'Vous avez défini cette adresse e-mail comme adresse primaire.', 'de': "Sie haben diese E-Mail-Adresse zu Ihrer Hauptadresse gemacht.", 'es': "Has convertido esta dirección de correo electrónico en principal.", 'pt': "Configuraste esta caixa de e-mail como principal.", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': 'הפכת את כתובת הדואר האלקטרוני הזאת לראשית.'}
            ...
            _password_reset_on_speedy_net_subject_dict = {'en': "Password reset on Speedy Net", 'fr': "Réinitialisation du mot de passe sur Speedy Net", 'de': "Passwort auf Speedy Net zurücksetzen", 'es': "Contraseña restablecida en Speedy Net", 'pt': "Redefinição de palavra-passe em Speedy Net", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': "איפוס סיסמה בספידי נט"}
            _password_reset_on_speedy_match_subject_dict = {'en': "Password reset on Speedy Match", 'fr': "Réinitialisation du mot de passe sur Speedy Match", 'de': "Passwort auf Speedy Match zurücksetzen", 'es': "Contraseña restablecida en Speedy Match", 'pt': "Redefinição de palavra-passe em Speedy Match", 'it': "_____ # ~~~~ TODO", 'nl': "_____ # ~~~~ TODO", 'sv': "_____ # ~~~~ TODO", 'ko': "_____ # ~~~~ TODO", 'fi': "_____ # ~~~~ TODO", 'he': "איפוס סיסמה בספידי מץ'"}
