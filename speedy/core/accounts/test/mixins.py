...
if (django_settings.TESTS):
    ...
    class SpeedyCoreAccountsLanguageMixin(SpeedyCoreBaseLanguageMixin, TestCaseMixin):
        ...
        def set_up(self):
            ...
            _speedy_net_deleted_user_name_dict = {'en': 'Speedy Net User', 'fr': 'Utilisateur de Speedy Net', 'de': 'Speedy Net Benutzer', 'es': 'Usuario de Speedy Net', 'pt': 'Utilizador do Speedy Net', 'it': 'Utente Speedy Net', 'nl': 'Speedy Net Gebruiker', 'ja': 'Speedy Net User', 'ru': 'Speedy Net User', 'zh': 'Speedy Net User', 'pl': 'Speedy Net User', 'fa': 'Speedy Net User', 'he': 'משתמש/ת ספידי נט', 'ko': 'Speedy Net 사용자', 'ar': 'Speedy Net User', 'id': 'Speedy Net User', 'uk': 'Speedy Net User', 'tr': 'Speedy Net User', 'vi': 'Speedy Net User', 'cs': 'Speedy Net User', 'sv': 'Speedy Net Användare', 'fi': 'Speedy Net Käyttäjä', 'hu': 'Speedy Net User', 'th': 'Speedy Net User', 'el': 'Speedy Net User', 'ms': 'Speedy Net User', 'sr': 'Speedy Net User', 'ro': 'Speedy Net User', 'bn': 'Speedy Net User', 'ca': 'Speedy Net User', 'no': 'Speedy Net User', 'bg': 'Speedy Net User', 'da': 'Speedy Net User', 'sk': 'Speedy Net User', 'hi': 'Speedy Net User', 'et': 'Speedy Net User', 'hr': 'Speedy Net User'}
            _speedy_match_deleted_user_name_dict = {'en': 'Speedy Match User', 'fr': 'Utilisateur de Speedy Match', 'de': 'Speedy Match Benutzer', 'es': 'Usuario de Speedy Match', 'pt': 'Utilizador do Speedy Match', 'it': 'Utente Speedy Match', 'nl': 'Speedy Match Gebruiker', 'ja': 'Speedy Match User', 'ru': 'Speedy Match User', 'zh': 'Speedy Match User', 'pl': 'Speedy Match User', 'fa': 'Speedy Match User', 'he': "משתמש/ת ספידי מץ'", 'ko': 'Speedy Match 사용자', 'ar': 'Speedy Match User', 'id': 'Speedy Match User', 'uk': 'Speedy Match User', 'tr': 'Speedy Match User', 'vi': 'Speedy Match User', 'cs': 'Speedy Match User', 'sv': 'Speedy Match Användare', 'fi': 'Speedy Match Käyttäjä', 'hu': 'Speedy Match User', 'th': 'Speedy Match User', 'el': 'Speedy Match User', 'ms': 'Speedy Match User', 'sr': 'Speedy Match User', 'ro': 'Speedy Match User', 'bn': 'Speedy Match User', 'ca': 'Speedy Match User', 'no': 'Speedy Match User', 'bg': 'Speedy Match User', 'da': 'Speedy Match User', 'sk': 'Speedy Match User', 'hi': 'Speedy Match User', 'et': 'Speedy Match User', 'hr': 'Speedy Match User'}
