...
if (django_settings.TESTS):
    ...
    class SpeedyCoreAccountsLanguageMixin(SpeedyCoreBaseLanguageMixin):
        ...
        def set_up(self):
            ...
            _the_email_address_was_deleted_error_message_dict = {'en': 'The email address was deleted.', 'fr': 'L’adresse e-mail a été supprimée.', 'de': "Die E-Mail-Adresse wurde gelöscht.", 'es': "La dirección de correo electrónico fue eliminada.", 'pt': "A direcção de e-mail foi excluída.", 'it': "L'indirizzo e-mail è stato eliminato.", 'nl': "Het e-mailadres is verwijderd.", 'sv': "E-postadressen raderades.", 'ko': "이메일 주소가 삭제되었습니다.", 'fi': "_____ # ~~~~ TODO", 'he': 'כתובת הדואר האלקטרוני נמחקה.'}
