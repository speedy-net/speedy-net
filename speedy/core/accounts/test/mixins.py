...
if (django_settings.TESTS):
    ...
    class SpeedyCoreAccountsLanguageMixin(SpeedyCoreBaseLanguageMixin):
        ...
        def set_up(self):
            ...
            _the_two_password_fields_didnt_match_error_message_dict = {'en': "The two password fields didn’t match.", 'fr': "Les deux mots de passe ne correspondent pas.", 'de': "Die beiden Passwörter sind nicht identisch.", 'es': "Los dos campos de contraseña no coinciden.", 'pt': "Os dois campos de senha não correspondem.", 'it': "I due campi password non corrispondono.", 'nl': "De twee wachtwoordvelden komen niet overeen.", 'sv': "De två lösenordsfälten stämmer inte överens.", 'ko': "비밀번호가 일치하지 않습니다.", 'fi': "Salasanakentät eivät täsmänneet.", 'he': 'שני שדות הסיסמה אינם זהים.'}
