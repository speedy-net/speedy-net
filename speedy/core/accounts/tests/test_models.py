    ...
    if (django_settings.LOGIN_ENABLED):
        class UserTestCaseMixin(SpeedyCoreAccountsModelsMixin, SpeedyCoreAccountsLanguageMixin):
            ...
            def test_user_profile_last_visit_str(self):
                ...
                self.assertIs(expr1={'en': "(3\xa0months, 1\xa0week\xa0ago)", 'he': "(לפני\xa03\xa0חודשים, שבוע)"}[self.language_code] in user_10.profile.last_visit_str, expr2=True)
                user_11 = ActiveUserFactory()
                user_11.profile.last_visit -= relativedelta(months=3, weeks=2)
                user_11.save_user_and_profile()
                self.assertIs(expr1={'en': "(3\xa0months, 2\xa0weeks\xa0ago)", 'he': "(לפני\xa03\xa0חודשים, שבועיים)"}[self.language_code] in user_11.profile.last_visit_str, expr2=True)
                ...
                self.assertIs(expr1={'en': "(1\xa0year, 1\xa0month\xa0ago)", 'he': "(לפני\xa0שנה, חודש)"}[self.language_code] in user_14.profile.last_visit_str, expr2=True)
                user_15 = ActiveUserFactory()
                user_15.profile.last_visit -= relativedelta(years=1, months=1, weeks=1)
                user_15.save_user_and_profile()
                self.assertIs(expr1={'en': "(1\xa0year, 1\xa0month\xa0ago)", 'he': "(לפני\xa0שנה, חודש)"}[self.language_code] in user_15.profile.last_visit_str, expr2=True)
                ...
                self.assertIs(expr1={'en': "(11\xa0months, 4\xa0weeks\xa0ago)", 'he': "(לפני\xa011\xa0חודשים, 4\xa0שבועות)"}[self.language_code] in user_18.profile.last_visit_str, expr2=True)
                ...
                self.assertIs(expr1={'en': "(11\xa0months, 3\xa0weeks\xa0ago)", 'he': "(לפני\xa011\xa0חודשים, 3\xa0שבועות)"}[self.language_code] in user_19.profile.last_visit_str, expr2=True)
                ...
                self.assertIs(expr1={'en': "(1\xa0year, 11\xa0months\xa0ago)", 'he': "(לפני\xa0שנה, 11\xa0חודשים)"}[self.language_code] in user_20.profile.last_visit_str, expr2=True)
