    ...
    if (django_settings.LOGIN_ENABLED):
        class UserTestCaseMixin(SpeedyCoreAccountsModelsMixin, SpeedyCoreAccountsLanguageMixin):
            ...
            def test_user_profile_last_visit_str(self):
                ...
                self.assertIs(expr1={'en': "(11\xa0months, 3\xa0weeks\xa0ago)", 'he': "(לפני\xa011\xa0חודשים, 3\xa0שבועות)"}[self.language_code] in user_18.profile.last_visit_str, expr2=True)
                ...
                self.assertIs(expr1={'en': "(11\xa0months, 2\xa0weeks\xa0ago)", 'he': "(לפני\xa011\xa0חודשים, שבועיים)"}[self.language_code] in user_19.profile.last_visit_str, expr2=True)
