    ...
    if (django_settings.LOGIN_ENABLED):
        ...
        class UserTestCaseMixin(SpeedyCoreAccountsModelsMixin, SpeedyCoreAccountsLanguageMixin):
            ...
            def test_user_profile_last_visit_str(self):
                ...
                print(user_3.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(2\xa0days\xa0ago)", 'fr': "(il\xa0y\xa0a\xa02\xa0jours)", 'de': "(vor\xa02\xa0Tage)", 'es': "(hace\xa02\xa0días)", 'pt': "(há\xa02\xa0dias)", 'it': "(2\xa0giorni\xa0fa)", 'nl': "(2\xa0dagen\xa0geleden)", 'sv': "(2\xa0dagar\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(2\xa0p\xa0iv\xa0\xa0sitten)", 'he': "(לפני\xa0יומיים)"}[self.language_code] in user_3.profile.last_visit_str, expr2=True)
                user_4 = ActiveUserFactory()
                user_4.profile.last_visit -= relativedelta(days=3)
                user_4.save_user_and_profile()
                print(user_4.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(3\xa0days\xa0ago)", 'fr': "(il\xa0y\xa0a\xa03\xa0jours)", 'de': "(vor\xa03\xa0Tage)", 'es': "(hace\xa03\xa0días)", 'pt': "(há\xa03\xa0dias)", 'it': "(3\xa0giorni\xa0fa)", 'nl': "(3\xa0dagen\xa0geleden)", 'sv': "(3\xa0dagar\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(3\xa0p\xa0iv\xa0\xa0sitten)", 'he': "(לפני\xa03\xa0ימים)"}[self.language_code] in user_4.profile.last_visit_str, expr2=True)
                user_5 = ActiveUserFactory()
                user_5.profile.last_visit -= relativedelta(weeks=1)
                user_5.save_user_and_profile()
                print(user_5.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(1\xa0week\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0semaine)", 'de': "(vor\xa01\xa0Woche)", 'es': "(hace\xa01\xa0semana)", 'pt': "(há\xa01\xa0semana)", 'it': "(1\xa0settimana\xa0fa)", 'nl': "(1\xa0week\xa0geleden)", 'sv': "(1\xa0vecka\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(1\xa0viikko\xa0sitten)", 'he': "(לפני\xa0שבוע)"}[self.language_code] in user_5.profile.last_visit_str, expr2=True)
                ...
                #self.assertIs(expr1={'en': "(2\xa0weeks\xa0ago)", 'fr': "(il\xa0y\xa0a\xa02\xa0semaines)", 'de': "(vor\xa02\xa0Wochen)", 'es': "(hace\xa02\xa0semanas)", 'pt': "(há\xa02\xa0semanas)", 'it': "(2\xa0settimane\xa0fa)", 'nl': "(2\xa0weken\xa0geleden)", 'sv': "(2\xa0veckor\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(2\xa0viikkoa\xa0sitten)", 'he': "(לפני\xa0שבועיים)"}[self.language_code] in user_6.profile.last_visit_str, expr2=True)
                ...
                #self.assertIs(expr1={'en': "(1\xa0month\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0mois)", 'de': "(vor\xa01\xa0Monat)", 'es': "(hace\xa01\xa0mes)", 'pt': "(há\xa01\xa0mês)", 'it': "(1\xa0mese\xa0fa)", 'nl': "(1\xa0maand\xa0geleden)", 'sv': "(1\xa0m\xa0nad\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(1\xa0kuukausi\xa0sitten)", 'he': "(לפני\xa0חודש)"}[self.language_code] in user_7.profile.last_visit_str, expr2=True)
                ...
                #self.assertIs(expr1={'en': "(2\xa0months\xa0ago)", 'fr': "(il\xa0y\xa0a\xa02\xa0mois)", 'de': "(vor\xa02\xa0Monate)", 'es': "(hace\xa02\xa0meses)", 'pt': "(há\xa02\xa0meses)", 'it': "(2\xa0mesi\xa0fa)", 'nl': "(2\xa0maanden\xa0geleden)", 'sv': "(2\xa0m\xa0nader\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(2\xa0kuukautta\xa0\xa0sitten)", 'he': "(לפני\xa0חודשיים)"}[self.language_code] in user_8.profile.last_visit_str, expr2=True)
                user_9 = ActiveUserFactory()
                user_9.profile.last_visit -= relativedelta(months=3)
                user_9.save_user_and_profile()
                print(user_9.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(3\xa0months\xa0ago)", 'fr': "(il\xa0y\xa0a\xa03\xa0mois)", 'de': "(vor\xa03\xa0Monate)", 'es': "(hace\xa03\xa0meses)", 'pt': "(há\xa03\xa0meses)", 'it': "(3\xa0mesi\xa0fa)", 'nl': "(3\xa0maanden\xa0geleden)", 'sv': "(3\xa0m\xa0nader\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(3\xa0kuukautta\xa0\xa0sitten)", 'he': "(לפני\xa03\xa0חודשים)"}[self.language_code] in user_9.profile.last_visit_str, expr2=True)
                user_10 = ActiveUserFactory()
                user_10.profile.last_visit -= relativedelta(months=3, weeks=1)
                user_10.save_user_and_profile()
                print(user_10.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(3\xa0months, 1\xa0week\xa0ago)", 'fr': "(il\xa0y\xa0a\xa03\xa0mois, 1\xa0semaine)", 'de': "(vor\xa03\xa0Monate, 1\xa0Woche)", 'es': "(hace\xa03\xa0meses, 1\xa0semana)", 'pt': "(há\xa03\xa0meses, 1\xa0semana)", 'it': "(3\xa0mesi, 1\xa0settimana\xa0fa)", 'nl': "(3\xa0maanden, 1\xa0week\xa0geleden)", 'sv': "(3\xa0m\xa0nader, 1\xa0vecka\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(3\xa0kuukautta\xa0, 1\xa0viikko\xa0sitten)", 'he': "(לפני\xa03\xa0חודשים ושבוע)"}[self.language_code] in user_10.profile.last_visit_str, expr2=True)
                user_11 = ActiveUserFactory()
                user_11.profile.last_visit -= relativedelta(months=3, weeks=2)
                user_11.save_user_and_profile()
                print(user_11.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(3\xa0months, 2\xa0weeks\xa0ago)", 'fr': "(il\xa0y\xa0a\xa03\xa0mois, 2\xa0semaines)", 'de': "(vor\xa03\xa0Monate, 2\xa0Wochen)", 'es': "(hace\xa03\xa0meses, 2\xa0semanas)", 'pt': "(há\xa03\xa0meses, 2\xa0semanas)", 'it': "(3\xa0mesi, 2\xa0settimane\xa0fa)", 'nl': "(3\xa0maanden, 2\xa0weken\xa0geleden)", 'sv': "(3\xa0m\xa0nader, 2\xa0veckor\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(3\xa0kuukautta\xa0, 2\xa0viikkoa\xa0sitten)", 'he': "(לפני\xa03\xa0חודשים ושבועיים)"}[self.language_code] in user_11.profile.last_visit_str, expr2=True)
                user_12 = ActiveUserFactory()
                user_12.profile.last_visit -= relativedelta(years=1)
                user_12.save_user_and_profile()
                print(user_12.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(1\xa0year\xa0ago)", 'fr': " (il\xa0y\xa0a\xa01\xa0année)", 'de': "(vor\xa01\xa0Jahr)", 'es': "(hace\xa01\xa0años)", 'pt': "(há\xa01\xa0ano)", 'it': "(1\xa0anno\xa0fa)", 'nl': "(1\xa0jaar\xa0geleden)", 'sv': "(1\xa0\xa0r\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(1\xa0vuosi\xa0sitten)", 'he': "(לפני\xa0שנה)"}[self.language_code] in user_12.profile.last_visit_str, expr2=True)
                user_13 = ActiveUserFactory()
                user_13.profile.last_visit -= relativedelta(years=1, weeks=1)
                user_13.save_user_and_profile()
                print(user_13.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(1\xa0year\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0année)", 'de': "(vor\xa01\xa0Jahr)", 'es': "(hace\xa01\xa0años)", 'pt': "(há\xa01\xa0ano)", 'it': "(1\xa0anno\xa0fa)", 'nl': "(1\xa0jaar\xa0geleden)", 'sv': "(1\xa0\xa0r\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(1\xa0vuosi\xa0sitten)", 'he': "(לפני\xa0שנה)"}[self.language_code] in user_13.profile.last_visit_str, expr2=True)
                user_14 = ActiveUserFactory()
                user_14.profile.last_visit -= relativedelta(years=1, months=1)
                user_14.save_user_and_profile()
                print(user_14.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(1\xa0year, 1\xa0month\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0année, 1\xa0mois)", 'de': "(vor\xa01\xa0Jahr, 1\xa0Monat)", 'es': "(hace\xa01\xa0años, 1\xa0mes)", 'pt': "(há\xa01\xa0ano, 1\xa0mês)", 'it': "(1\xa0anno, 1\xa0mese\xa0fa)", 'nl': "(1\xa0jaar, 1\xa0maand\xa0geleden)", 'sv': "(1\xa0\xa0r, 1\xa0m\xa0nad\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(1\xa0vuosi, 1\xa0kuukausi\xa0sitten)", 'he': "(לפני\xa0שנה וחודש)"}[self.language_code] in user_14.profile.last_visit_str, expr2=True)
                user_15 = ActiveUserFactory()
                user_15.profile.last_visit -= relativedelta(years=1, months=1, weeks=1)
                user_15.save_user_and_profile()
                print(user_15.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(1\xa0year, 1\xa0month\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0année, 1\xa0mois)", 'de': "(vor\xa01\xa0Jahr, 1\xa0Monat)", 'es': "(hace\xa01\xa0años, 1\xa0mes)", 'pt': "(há\xa01\xa0ano, 1\xa0mês)", 'it': "(1\xa0anno, 1\xa0mese\xa0fa)", 'nl': "(1\xa0jaar, 1\xa0maand\xa0geleden)", 'sv': "(1\xa0\xa0r, 1\xa0m\xa0nad\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(1\xa0vuosi, 1\xa0kuukausi\xa0sitten)", 'he': "(לפני\xa0שנה וחודש)"}[self.language_code] in user_15.profile.last_visit_str, expr2=True)
                user_16 = ActiveUserFactory()
                user_16.profile.last_visit -= relativedelta(years=2)
                user_16.save_user_and_profile()
                print(user_16.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(2\xa0years\xa0ago)", 'fr': "(il\xa0y\xa0a\xa02\xa0années)", 'de': "(vor\xa02\xa0Jahre)", 'es': "(hace\xa02\xa0años)", 'pt': "(há\xa02\xa0anos)", 'it': "(2\xa0anni\xa0fa)", 'nl': "(2\xa0jaar\xa0geleden)", 'sv': "(2\xa0\xa0r\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(2\xa0vuotta\xa0sitten)", 'he': "(לפני\xa0שנתיים)"}[self.language_code] in user_16.profile.last_visit_str, expr2=True)
                user_17 = ActiveUserFactory()
                user_17.profile.last_visit -= relativedelta(years=2, weeks=2)
                user_17.save_user_and_profile()
                print(user_17.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(2\xa0years\xa0ago)", 'fr': "(il\xa0y\xa0a\xa02\xa0années)", 'de': "(vor\xa02\xa0Jahre)", 'es': "(hace\xa02\xa0años)", 'pt': "(há\xa02\xa0anos)", 'it': "(2\xa0anni\xa0fa)", 'nl': "(2\xa0jaar\xa0geleden)", 'sv': "(2\xa0\xa0r\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(2\xa0vuotta\xa0sitten)", 'he': "(לפני\xa0שנתיים)"}[self.language_code] in user_17.profile.last_visit_str, expr2=True)
                ...
                #self.assertIs(expr1={'en': "(11\xa0months, 3\xa0weeks\xa0ago)", 'fr': "(il\xa0y\xa0a\xa011\xa0mois, 3\xa0semaines)", 'de': "(vor\xa011\xa0Monate, 3\xa0Wochen)", 'es': "(hace\xa011\xa0meses, 3\xa0semanas)", 'pt': "(há\xa011\xa0meses, 3\xa0semanas)", 'it': "(11\xa0mesi, 3\xa0settimane\xa0fa)", 'nl': "(11\xa0maanden, 3\xa0weken\xa0geleden)", 'sv': "(11\xa0m\xa0nader, 3\xa0veckor\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(11\xa0kuukautta\xa0, 3\xa0viikkoa\xa0sitten)", 'he': "(לפני\xa011\xa0חודשים ו-3\xa0שבועות)"}[self.language_code] in user_18.profile.last_visit_str, expr2=True)
                ...
                #self.assertIs(expr1={'en': "(11\xa0months, 2\xa0weeks\xa0ago)", 'fr': "(il\xa0y\xa0a\xa011\xa0mois, 2\xa0semaines)", 'de': "(vor\xa011\xa0Monate, 2\xa0Wochen)", 'es': "(hace\xa011\xa0meses, 2\xa0semanas)", 'pt': "(há\xa011\xa0meses, 2\xa0semanas)", 'it': "(11\xa0mesi, 2\xa0settimane\xa0fa)", 'nl': "(11\xa0maanden, 2\xa0weken\xa0geleden)", 'sv': "(11\xa0m\xa0nader, 2\xa0veckor\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(11\xa0kuukautta\xa0, 2\xa0viikkoa\xa0sitten)", 'he': "(לפני\xa011\xa0חודשים ושבועיים)"}[self.language_code] in user_19.profile.last_visit_str, expr2=True)
                ...
                print(user_20.profile.last_visit_str)
                #self.assertIs(expr1={'en': "(1\xa0year, 11\xa0months\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0année, 11\xa0mois)", 'de': "(vor\xa01\xa0Jahr, 11\xa0Monate)", 'es': "(hace\xa01\xa0años, 11\xa0meses)", 'pt': "(há\xa01\xa0ano, 11\xa0meses)", 'it': "(1\xa0anno, 11\xa0mesi\xa0fa)", 'nl': "(1\xa0jaar, 11\xa0maanden\xa0geleden)", 'sv': "(1\xa0\xa0r, 11\xa0m\xa0nader\xa0sedan)", 'ko': "_____ # ~~~~ TODO", 'fi': "(1\xa0vuosi, 11\xa0kuukautta\xa0\xa0sitten)", 'he': "(לפני\xa0שנה ו-11\xa0חודשים)"}[self.language_code] in user_20.profile.last_visit_str, expr2=True)
