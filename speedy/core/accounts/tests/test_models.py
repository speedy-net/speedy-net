    ...
    if (django_settings.LOGIN_ENABLED):
        ...
        class UserTestCaseMixin(SpeedyCoreAccountsModelsMixin, SpeedyMatchAccountsModelsMixin, SpeedyCoreAccountsLanguageMixin, SpeedyMatchAccountsLanguageMixin):
            ...
            def test_user_profile_last_visit_str(self):
                ...
                self.assertIs(expr1={'en': "(1\xa0year\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0année)", 'de': "(vor\xa01\xa0Jahr)", 'es': "(hace\xa01\xa0año)", 'pt': "(há\xa01\xa0ano)", 'it': "(1\xa0anno\xa0fa)", 'nl': "(1\xa0jaar\xa0geleden)", 'sv': "(1\xa0år\xa0sedan)", 'ko': "(1년\xa0전에)", 'fi': "(1\xa0vuosi\xa0sitten)", 'he': "(לפני\xa0שנה)"}[self.language_code] in user_15.profile.last_visit_str, expr2=True)
                user_16 = ActiveUserFactory()
                user_16.profile.last_visit -= relativedelta(years=1, weeks=1)
                user_16.save_user_and_profile()
                self.assertIs(expr1={'en': "(1\xa0year\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0année)", 'de': "(vor\xa01\xa0Jahr)", 'es': "(hace\xa01\xa0año)", 'pt': "(há\xa01\xa0ano)", 'it': "(1\xa0anno\xa0fa)", 'nl': "(1\xa0jaar\xa0geleden)", 'sv': "(1\xa0år\xa0sedan)", 'ko': "(1년\xa0전에)", 'fi': "(1\xa0vuosi\xa0sitten)", 'he': "(לפני\xa0שנה)"}[self.language_code] in user_16.profile.last_visit_str, expr2=True)
                ...
                self.assertIs(expr1={'en': "(2\xa0years\xa0ago)", 'fr': "(il\xa0y\xa0a\xa02\xa0ans)", 'de': "(vor\xa02\xa0Jahre)", 'es': "(hace\xa02\xa0años)", 'pt': "(há\xa02\xa0anos)", 'it': "(2\xa0anni\xa0fa)", 'nl': "(2\xa0jaar\xa0geleden)", 'sv': "(2\xa0år\xa0sedan)", 'ko': "(2년\xa0전에)", 'fi': "(2\xa0vuotta\xa0sitten)", 'he': "(לפני\xa0שנתיים)"}[self.language_code] in user_19.profile.last_visit_str, expr2=True)
                user_20 = ActiveUserFactory()
                user_20.profile.last_visit -= relativedelta(years=2, weeks=2)
                user_20.save_user_and_profile()
                self.assertIs(expr1={'en': "(2\xa0years\xa0ago)", 'fr': "(il\xa0y\xa0a\xa02\xa0ans)", 'de': "(vor\xa02\xa0Jahre)", 'es': "(hace\xa02\xa0años)", 'pt': "(há\xa02\xa0anos)", 'it': "(2\xa0anni\xa0fa)", 'nl': "(2\xa0jaar\xa0geleden)", 'sv': "(2\xa0år\xa0sedan)", 'ko': "(2년\xa0전에)", 'fi': "(2\xa0vuotta\xa0sitten)", 'he': "(לפני\xa0שנתיים)"}[self.language_code] in user_20.profile.last_visit_str, expr2=True)
