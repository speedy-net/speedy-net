    ...
    if (django_settings.LOGIN_ENABLED):
        ...
        class UserTestCaseMixin(SpeedyCoreAccountsModelsMixin, SpeedyCoreAccountsLanguageMixin):
            ...
            def test_user_profile_last_visit_str(self):
                ...
                self.assertIs(expr1={'en': "(1\xa0month\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0mois)", 'de': "(vor\xa01\xa0Monat)", 'es': "(hace\xa01\xa0mes)", 'pt': "(há\xa01\xa0mês)", 'it': "(1\xa0mese\xa0fa)", 'nl': "(1\xa0maand\xa0geleden)", 'sv': "(1\xa0månad\xa0sedan)", 'ko': "(1개월\xa0전에)", 'fi': "(1\xa0kuukausi\xa0sitten)", 'he': "(לפני\xa0חודש)"}[self.language_code] in user_7.profile.last_visit_str, expr2=True)
                ...
                self.assertIs(expr1={'en': "(1\xa0year\xa0ago)", 'fr': " (il\xa0y\xa0a\xa01\xa0année)", 'de': "(vor\xa01\xa0Jahr)", 'es': "(hace\xa01\xa0años)", 'pt': "(há\xa01\xa0ano)", 'it': "(1\xa0anno\xa0fa)", 'nl': "(1\xa0jaar\xa0geleden)", 'sv': "(1\xa0år\xa0sedan)", 'ko': "(1년\xa0전에)", 'fi': "(1\xa0vuosi\xa0sitten)", 'he': "(לפני\xa0שנה)"}[self.language_code] in user_12.profile.last_visit_str, expr2=True)
                user_13 = ActiveUserFactory()
                user_13.profile.last_visit -= relativedelta(years=1, weeks=1)
                user_13.save_user_and_profile()
                self.assertIs(expr1={'en': "(1\xa0year\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0année)", 'de': "(vor\xa01\xa0Jahr)", 'es': "(hace\xa01\xa0años)", 'pt': "(há\xa01\xa0ano)", 'it': "(1\xa0anno\xa0fa)", 'nl': "(1\xa0jaar\xa0geleden)", 'sv': "(1\xa0år\xa0sedan)", 'ko': "(1년\xa0전에)", 'fi': "(1\xa0vuosi\xa0sitten)", 'he': "(לפני\xa0שנה)"}[self.language_code] in user_13.profile.last_visit_str, expr2=True)
                user_14 = ActiveUserFactory()
                user_14.profile.last_visit -= relativedelta(years=1, months=1)
                user_14.save_user_and_profile()
                self.assertIs(expr1={'en': "(1\xa0year, 1\xa0month\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0année, 1\xa0mois)", 'de': "(vor\xa01\xa0Jahr, 1\xa0Monat)", 'es': "(hace\xa01\xa0años, 1\xa0mes)", 'pt': "(há\xa01\xa0ano, 1\xa0mês)", 'it': "(1\xa0anno, 1\xa0mese\xa0fa)", 'nl': "(1\xa0jaar, 1\xa0maand\xa0geleden)", 'sv': "(1\xa0år, 1\xa0månad\xa0sedan)", 'ko': "(1년, 1개월\xa0전에)", 'fi': "(1\xa0vuosi, 1\xa0kuukausi\xa0sitten)", 'he': "(לפני\xa0שנה וחודש)"}[self.language_code] in user_14.profile.last_visit_str, expr2=True)
                user_15 = ActiveUserFactory()
                user_15.profile.last_visit -= relativedelta(years=1, months=1, weeks=1)
                user_15.save_user_and_profile()
                self.assertIs(expr1={'en': "(1\xa0year, 1\xa0month\xa0ago)", 'fr': "(il\xa0y\xa0a\xa01\xa0année, 1\xa0mois)", 'de': "(vor\xa01\xa0Jahr, 1\xa0Monat)", 'es': "(hace\xa01\xa0años, 1\xa0mes)", 'pt': "(há\xa01\xa0ano, 1\xa0mês)", 'it': "(1\xa0anno, 1\xa0mese\xa0fa)", 'nl': "(1\xa0jaar, 1\xa0maand\xa0geleden)", 'sv': "(1\xa0år, 1\xa0månad\xa0sedan)", 'ko': "(1년, 1개월\xa0전에)", 'fi': "(1\xa0vuosi, 1\xa0kuukausi\xa0sitten)", 'he': "(לפני\xa0שנה וחודש)"}[self.language_code] in user_15.profile.last_visit_str, expr2=True)
                user_16 = ActiveUserFactory()
                user_16.profile.last_visit -= relativedelta(years=2)
                user_16.save_user_and_profile()
                self.assertIs(expr1={'en': "(2\xa0years\xa0ago)", 'fr': "(il\xa0y\xa0a\xa02\xa0années)", 'de': "(vor\xa02\xa0Jahre)", 'es': "(hace\xa02\xa0años)", 'pt': "(há\xa02\xa0anos)", 'it': "(2\xa0anni\xa0fa)", 'nl': "(2\xa0jaar\xa0geleden)", 'sv': "(2\xa0år\xa0sedan)", 'ko': "(2년\xa0전에)", 'fi': "(2\xa0vuotta\xa0sitten)", 'he': "(לפני\xa0שנתיים)"}[self.language_code] in user_16.profile.last_visit_str, expr2=True)
                user_17 = ActiveUserFactory()
                user_17.profile.last_visit -= relativedelta(years=2, weeks=2)
                user_17.save_user_and_profile()
                self.assertIs(expr1={'en': "(2\xa0years\xa0ago)", 'fr': "(il\xa0y\xa0a\xa02\xa0années)", 'de': "(vor\xa02\xa0Jahre)", 'es': "(hace\xa02\xa0años)", 'pt': "(há\xa02\xa0anos)", 'it': "(2\xa0anni\xa0fa)", 'nl': "(2\xa0jaar\xa0geleden)", 'sv': "(2\xa0år\xa0sedan)", 'ko': "(2년\xa0전에)", 'fi': "(2\xa0vuotta\xa0sitten)", 'he': "(לפני\xa0שנתיים)"}[self.language_code] in user_17.profile.last_visit_str, expr2=True)
                ...
                self.assertIs(expr1={'en': "(11\xa0months, 3\xa0weeks\xa0ago)", 'fr': "(il\xa0y\xa0a\xa011\xa0mois, 3\xa0semaines)", 'de': "(vor\xa011\xa0Monate, 3\xa0Wochen)", 'es': "(hace\xa011\xa0meses, 3\xa0semanas)", 'pt': "(há\xa011\xa0meses, 3\xa0semanas)", 'it': "(11\xa0mesi, 3\xa0settimane\xa0fa)", 'nl': "(11\xa0maanden, 3\xa0weken\xa0geleden)", 'sv': "(11\xa0månader, 3\xa0veckor\xa0sedan)", 'ko': "(11개월, 3주\xa0전에)", 'fi': "(11\xa0kuukautta\xa0, 3\xa0viikkoa\xa0sitten)", 'he': "(לפני\xa011\xa0חודשים ו-3\xa0שבועות)"}[self.language_code] in user_18.profile.last_visit_str, expr2=True)
                ...
                self.assertIs(expr1={'en': "(11\xa0months, 2\xa0weeks\xa0ago)", 'fr': "(il\xa0y\xa0a\xa011\xa0mois, 2\xa0semaines)", 'de': "(vor\xa011\xa0Monate, 2\xa0Wochen)", 'es': "(hace\xa011\xa0meses, 2\xa0semanas)", 'pt': "(há\xa011\xa0meses, 2\xa0semanas)", 'it': "(11\xa0mesi, 2\xa0settimane\xa0fa)", 'nl': "(11\xa0maanden, 2\xa0weken\xa0geleden)", 'sv': "(11\xa0månader, 2\xa0veckor\xa0sedan)", 'ko': "(11개월, 2주\xa0전에)", 'fi': "(11\xa0kuukautta\xa0, 2\xa0viikkoa\xa0sitten)", 'he': "(לפני\xa011\xa0חודשים ושבועיים)"}[self.language_code] in user_19.profile.last_visit_str, expr2=True)
